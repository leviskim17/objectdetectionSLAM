...
class GPUConfig {
 ...
 private:
  GPUConfig()
    ...
    icpStepMap["GeForce GTX 970M"] = std::pair<int, int>(128, 48);
    rgbStepMap["GeForce GTX 970M"] = std::pair<int, int>(160, 64);
    rgbResMap["GeForce GTX 970M"] = std::pair<int, int>(128, 272);
    so3StepMap["GeForce GTX 970M"] = std::pair<int, int>(96, 64);
